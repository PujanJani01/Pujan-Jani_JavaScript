...
//       value.fname = 'pujan'; return value;
// });
...
// let arr = [[],[],[],[]];
// let arr2 = arr.map((value) =>{value[0] = 'fname'; return value;});
// console.log(arr);
// console.log(arr2);
...
// let arr = [1,2,3,4,5];
// let arr2 = arr.map((value,index,array) => array[index] - value);
// console.log(arr);
// console.log(arr2);
...
// ]
// let similar = detail.map((person) => person.fname + ' ' + person.lname);
// console.log(detail);
// console.log(similar);

//--------------------------------------------------------------------------------------------------

// let cities = ['Gondal','Rajkot','Ahmedabad','Mumbai'];
...
// let cities = ['Gondal','Rajkot','Ahmedabad','Mumbai'];
// let newArr = cities.map((city) => {return {City: city}});
// console.log(cities);
// console.log(newArr);

//--------------------------------------------------------------------------------------------------

// let arr = [{a:1},{a:5,b:4},{c:6}];
// let arr2 = arr.map((value) => { 
//     value.b = 10;
//     return value;
// });
...
// let arr = 'hello world!';
// let arr2 = arr.split(' ');
// let arr3 = arr2.map((word) => word.toUpperCase());
// let arr4 = arr3.join(' ');
// console.log(arr3);
// console.log(arr4);
...
// let arr = 'hello world';
// let arr2 = arr.split(' ');
// let arr3 = arr2.map((word) => word.charAt(0).toUpperCase() + word.slice(1));
// let arr4 = arr3.join(' ');
// console.log(arr4);
...
// let arr = [1,2,3,4,5];
// let arr2 = arr.map((index,value,array) => array[index+1]);
// console.log(arr2);
