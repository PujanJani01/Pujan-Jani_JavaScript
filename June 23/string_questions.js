...
// let a = 'javascript is different than java';
// let regex = /java/g;
// let b = a.search(regex);
// console.log(b);

//-------------------------------------------------------------------------------------------------------

// let a = "javascript is different than java";
// let b = a.startsWith('java');
// console.log(b);
// let c =a.startsWith('script');
// console.log(c);
...
// console.log(is_string(null));           // false
...
// console.log(string_to_array("Robin Singh chaddha")); // ["Robin", "Singh"]
