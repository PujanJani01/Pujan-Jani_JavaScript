...
dice1.appendChild(coin1);
dice2.appendChild(coin2);
...
function player1() {
    ...
    if (100 - boxnum1 >= Number(dice1.innerText)) {
        switch (boxnum1) {
            case 4:
...
function player2() {
    ...
    if (100 - boxnum2 >= Number(dice2.innerText)) {
        switch (boxnum2) {
            case 4:
